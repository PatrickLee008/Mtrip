...
CREATE TABLE IF NOT EXISTS `marketing_campaign` (
  ...
  `funding_rules`  JSON      NULL COMMENT '共担比例{mtrip,merchant,partner}百分比(funding_source=4)',
  `requirements` VARCHAR(1000) NOT NULL DEFAULT '' COMMENT '参与资格要求(商户端活动详情展示)',
  `terms`        VARCHAR(1000) NOT NULL DEFAULT '' COMMENT '活动条款',
  `invite_mode`  TINYINT     NOT NULL DEFAULT 1 COMMENT '参与方式:1定向邀请 2公开报名',
